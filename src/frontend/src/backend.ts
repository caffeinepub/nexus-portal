...
export class Backend implements backendInterface {
    ...
    async createContent(arg0: ContentId, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createContent(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllContents(): Promise<Array<Content>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllContents();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getContent(arg0: ContentId): Promise<Content> {
        if (this.processError) {
            try {
    ...
    async updateContent(arg0: ContentId, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
